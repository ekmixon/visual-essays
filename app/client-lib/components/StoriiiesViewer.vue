...
/* global initialiseViewer */

const dependencies = [
    'https://cdnjs.cloudflare.com/ajax/libs/openseadragon/2.4.2/openseadragon.min.js',
    'https://storiiies.cogapp.com/assets/demos/viewer/js/shortcode.js'
]
...
module.exports = {
  ...
  methods: {
      init() {
        ...
        fetch('https://storiiies.cogapp.com/manifestJSON?manifest=' + manifest).then(resp => resp.json())
        .then(data => {
...
<style>
  ...
  .caption-box-show {
    ...
    left: 20px;
    z-index: 100;
    background: url("https://jstor-labs.github.io/juncture/images/show.svg") no-repeat center center;
  ...
  .caption-box__header .button--toggle {
    background: url("https://jstor-labs.github.io/juncture/images/hide.svg") no-repeat center center;
    width: 26px; }

  .caption-box__controls .button {
    width: 34px;
    height: 31px;
    background: url("https://jstor-labs.github.io/juncture/images/arrow.svg") no-repeat center center; }
