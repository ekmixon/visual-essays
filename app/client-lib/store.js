...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setServiceBaseURL (state, serviceBaseURL) { state.serviceBaseURL = serviceBaseURL },
  ...
  actions: {
    ...
    setServiceBaseURL: ({ commit }, serviceBaseURL) => commit('setServiceBaseURL', serviceBaseURL),
  ...
  getters: {
    ...
    serviceBaseURL: state => state.serviceBaseURL,
