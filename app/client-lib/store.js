...
export default new Vuex.Store({
  ...
  actions: {
    ...
    setServiceBase: ({ commit }, serviceBase) => commit('setServiceBase', serviceBase),
    setContentBase: ({ commit }, contentBase) => commit('setContentBase', contentBase),
  ...
  getters: {
    ...
    serviceBase: state => state.serviceBase,
    contentBase: state => state.contentBase,
